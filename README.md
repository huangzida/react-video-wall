<!-- TODO: replace <OWNER> with the real GitHub owner/org below (badges, demo link, degit command). -->
<p align="center">
...
<p align="center">
  ...
  <img alt="CI" src="https://img.shields.io/github/actions/workflow/status/<OWNER>/starter-react/ci.yml?branch=main&style=flat-square">
...
<p align="center">
  🔗 <a href="https://<OWNER>.github.io/starter-react/">在线演示</a>
</p>
...
```bash
npx degit <OWNER>/starter-react my-lib
cd my-lib
